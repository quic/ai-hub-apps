...
2. Copy the `.tflite` file to `src/main/assets/classifier.tflite`
3. Open this folder in Android Studio, run gradle sync, and build the `ImageClassification` target.
